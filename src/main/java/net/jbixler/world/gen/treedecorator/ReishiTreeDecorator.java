...
public class ReishiTreeDecorator extends TreeDecorator {
    public static final MapCodec<ReishiTreeDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(ReishiTreeDecorator::new, (decorator) -> {
        return decorator.probability;
    });

    private final float probability;

    public ReishiTreeDecorator(float probability) {
