...
public class ModEffects {
    public static final StatusEffect ACTIVATED_CHARCOAL = registerStatusEffect("activated_charcoal", new ActivatedCharoalEffect(StatusEffectCategory.BENEFICIAL, 0x000000FF));
