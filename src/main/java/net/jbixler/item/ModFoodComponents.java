...
public class ModFoodComponents {
    ...
    public static final FoodComponent LIONS_MANE = new FoodComponent.Builder().nutrition(4).saturationModifier(0.25f).build();
    public static final FoodComponent COOKED_LIONS_MANE = new FoodComponent.Builder().nutrition(8).saturationModifier(0.4f).build();
    public static final FoodComponent OYSTER_MUSHROOM = new FoodComponent.Builder().nutrition(3).saturationModifier(0.25f).build();
