...
public class ReishiMushroomBlock extends MushroomBlock {
    ...
    public ReishiMushroomBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (itemCount > 0) {
            ItemEntity itemEntity = new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.REISHI, itemCount));
